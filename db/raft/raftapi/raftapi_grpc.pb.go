...
type RaftKVServiceClient interface {
	...
	GetRestored(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*RestoredResponse, error)
...
func (c *raftKVServiceClient) GetRestored(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*RestoredResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type RaftKVServiceServer interface {
	...
	GetRestored(context.Context, *Empty) (*RestoredResponse, error)
...
func (UnimplementedRaftKVServiceServer) GetCacheHits(context.Context, *Empty) (*CacheHitsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCacheHits not implemented")
}
func (UnimplementedRaftKVServiceServer) ResetCacheHits(context.Context, *Empty) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ResetCacheHits not implemented")
}
func (UnimplementedRaftKVServiceServer) GetRestored(context.Context, *Empty) (*RestoredResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRestored not implemented")
}
func (UnimplementedRaftKVServiceServer) ResetRestored(context.Context, *Empty) (*Empty, error) {
	return nil, status.Error(codes.Unimplemented, "method ResetRestored not implemented")
}
...
func RegisterRaftKVServiceServer(s grpc.ServiceRegistrar, srv RaftKVServiceServer) {
	// If the following call panics, it indicates UnimplementedRaftKVServiceServer was
